  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="center margin_bottom_30_all"> <img class="margin_bottom_30_all" src="<?php echo get_template_directory_uri() ?>/assets/images/it_service/404_error_img.png" alt="#"> </div>
